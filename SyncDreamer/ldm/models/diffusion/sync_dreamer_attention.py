...
from ...modules.attention import default, zero_module, checkpoint
...
class DepthWiseAttention(UNetModel):
    ...
    def forward(self, x, timesteps=None, context=None, down_block_additional_residuals=None, mid_block_additional_residual=None, source_dict=None, **kwargs):
        hs = []
        ...
        if is_controlnet:
            ...
            for down_block_res_sample, down_block_additional_residual in zip(
                ...
                new_hs = new_hs + [down_block_res_sample]
    ...
    def get_trainable_parameters(self):
        ...
        # paras = [para for para in self.output_conditions.parameters()]
        return paras
