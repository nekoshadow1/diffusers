...
class StableDiffusionControlNetPipeline(
    ...
    def check_inputs(
        ...
        if (
            ...
            isinstance(self.controlnet, ControlNetModelSync)
            or is_compiled
            and isinstance(self.controlnet._orig_mod, ControlNetModelSync)
        ):
            self.check_image(image, prompt, prompt_embeds)
        else:
            assert False
    ...
    def prepare_image(
        ...
        # print('image.shape:', image.shape) torch.Size([1, 3, 256, 256])
