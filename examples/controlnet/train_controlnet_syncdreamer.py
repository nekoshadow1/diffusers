...
from SyncDreamer.ldm.models.diffusion.sync_dreamer import SyncMultiviewDiffusion, SyncDDIMSampler, UNetWrapper
from SyncDreamer.ldm.util import instantiate_from_config, prepare_inputs

if is_wandb_available():
    import wandb

# Help locate non-gradable tensor(s)
torch.autograd.set_detect_anomaly(True)

# Print more accurate cuda errors.
    ...
    if version.parse(accelerate.__version__) >= version.parse("0.16.0"):
        ...
        def load_model_hook(models, input_dir):
            while len(models) > 0:
                ...
                load_model = ControlNetModelSync.from_pretrained(input_dir, subfolder="controlnet")
